      ...
      <div class="mt-[200px] text-center">
        ...
        <div class="mb-4">
          <div class="dark:text-neutral-200">
            Tailwind Elements is a collection of
          ...
          <div class="mt-10 grid grid-cols-2 gap-6">
            ...
            <div>
              ...
              <div class="mt-4">
                <a
                  href="https://tailwind-elements.com/docs/standard/getting-started/quick-start/"
                  target="_blank"
              ...
              <div class="mt-4">
                ...
                <div class="mt-4">
                  <a
                    href="https://tailwind-elements.com/docs/standard/getting-started/optimization/"
                    target="_blank"
                    class="inline-block w-[300px] rounded bg-primary-100 px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-primary-700 transition duration-150 ease-in-out hover:bg-primary-accent-100 focus:bg-primary-accent-100 focus:outline-none focus:ring-0 active:bg-primary-accent-200">
            ...
            <div>
              ...
              <div class="mt-4">
                <a
                  href="https://github.com/mdbootstrap/Tailwind-Elements/discussions/categories/support-from-community"
                  target="_blank"
                  class="inline-block w-[300px] rounded bg-primary-100 px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-primary-700 transition duration-150 ease-in-out hover:bg-primary-accent-100 focus:bg-primary-accent-100 focus:outline-none focus:ring-0 active:bg-primary-accent-200">
                  USE SUPPORT
                </a>
          ...
          <div class="mt-10 pt-10">
            <p>
              <em
                >PS. Tailwind Elements is open-source & community driven.
                Currently, we're looking for contributors for the
                <a
                  target="_blank"
                  ...
                  href="https://github.com/mdbootstrap/Tailwind-Elements-React"
                  >Tailwind Elements React version</a
                >
